# Projeto final - curso diversificaDev 

def adicionar_tarefa(lista_de_tarefas, tarefa):
    """Adiciona nova tarefa a uma lista pré-exitente"""
...
def exibir_menu():
    """Exibe menu com opções para usuario escolher"""
    print("-" * 50)
...
while continuar: 
    ...
    if opcao == "1":
        ...
        # A valiadação verifica se o valor é númerico,se é menor do que o limite a lista e se é maior do que zero.
